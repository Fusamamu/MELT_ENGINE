...
namespace MELT
{
    ...
    {
        return ScreenToWorldRay(_cursorX, _cursorY, static_cast<int>(_camera.ScreenSize.x), static_cast<int>(_camera.ScreenSize.y), _camera.get_view_matrix(), _camera.get_orthographic_projection_matrix());
    }
